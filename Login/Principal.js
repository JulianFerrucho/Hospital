...
function Registrar(){
	...
	alert("Cargando Registro...");
	window.location='../Registro/RegistroPac.php';

}

function CambCont(){

	alert("Cargando Cambio...");
	window.location='../Registro/CambCont.php';

}
function Admin(){

	alert("Cargando Panel de Admninistracion...");
	window.location='../Admin/SesionAdmin.php';
